  ...
  export default function Footer() {
    return (
      <footer className="bg-black text-white border border-black rounded-xl">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 md:px-16 lg:px-20 py-8 sm:py-10 relative">
        <div className="text-xl sm:text-2xl font-bold pb-4 sm:pb-5">👋 Let&apos;s Connect</div>
          {/* Konten */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10 md:gap-12 border-t border-gray-700 pt-8 sm:pt-12">
            {/* Kiri - Logo & Deskripsi & Social */}
            <div className="space-y-4">
              <div className="text-xl sm:text-2xl font-bold">M.NOUVAL R</div>
              ...
              <div className="flex gap-4 text-gray-400">
                ...
                <Link href="mailto:m.nouvalrfqi@gmail.com">
                  ...
                  {/* Navigasi */}
          <div>
            <h4 className="text-orange-400 font-semibold mb-3 sm:mb-4">Navigation</h4>
            ...
            {/* Kontak */}
            <div>
              <h4 className="text-orange-400 font-semibold mb-3 sm:mb-4">Contact</h4>
              <ul className="space-y-2 text-sm text-gray-300">
          ...
          {/* Copyright */}
          <div className="mt-8 sm:mt-12 border-t border-gray-700 pt-4 sm:pt-6 text-xs sm:text-sm text-gray-400 flex flex-col sm:flex-row justify-between gap-2">
